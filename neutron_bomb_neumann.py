...
def _critical_radius(r):
    """
    This equation computes the critical radius for sphere smaller than which, no runaway reaction can occur
    """
...
def k_equation(k):
    """
    This equation computes the k factor for an operational radius R = 8.5 cm
    """
